...
- Refreshes the five-hour and weekly quotas every 60 seconds. The menu bar shows only the weekly quota (for example, `周 65%`); the five-hour quota and task details remain in the expanded menu.
